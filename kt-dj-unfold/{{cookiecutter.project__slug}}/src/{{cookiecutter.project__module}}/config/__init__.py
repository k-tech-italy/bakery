...
OPTIONS = dict(
    ...
    DATABASE_URL=(str, "psql://postgres:@127.0.0.1:5432/{{cookiecutter.project__module}}_db"),
    DEBUG=(bool, False),
    ...
    EMAIL_PORT=(int, 587),
    EMAIL_SUBJECT_PREFIX=(str, "[{{cookiecutter.project__module}}]"),
    EMAIL_USE_LOCALTIME=(bool, False),
    EMAIL_USE_TLS=(bool, True),
    EMAIL_USE_SSL=(bool, False),
    EMAIL_TIMEOUT=(int, 30),
    MEDIA_ROOT=(str, os.path.join(tempfile.gettempdir(), "{{cookiecutter.project__module}}", "media")),
