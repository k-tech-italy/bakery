...
INSTALLED_APPS = [
    ...
    '{{cookiecutter.project__slug}}.api',
...
if ddt_key := env('DDT_KEY'):
    ...
    def show_ddt(request):
        ...
        return request.META.get('HTTP_DEV_DDT') == ddt_key
...
CSP_STYLE_SRC = ("'self'", "'unsafe-inline'", "'unsafe-eval'", 'fonts.googleapis.com')
CSP_SCRIPT_SRC = ("'self'", "'unsafe-inline'", "'unsafe-eval'")
CSP_FONT_SRC = ("'self'", 'fonts.gstatic.com')
CSP_IMG_SRC = ("'self'", 'cdn.wfp.org')
