...
DEFAULTS = {
    ...
    'ALLOWED_HOSTS': (list, ''),
    'DATABASE_URL': (str, 'psql://postgres:@127.0.0.1:5432/django_kt_template_by_k_tech_db'),
    'DEBUG': (bool, False),
    ...
    'EMAIL_PORT': (int, 587),
    'EMAIL_SUBJECT_PREFIX': (str, '[django_kt_template_by_k_tech]'),
    ...
    'MEDIA_ROOT': (str, os.path.join(tempfile.gettempdir(), 'django_kt_template_by_k_tech', 'media')),
