...
def print_version(ctx, param, value):
    if not value or ctx.resilient_parsing:
        return
    click.echo('{{cookiecutter.project__module}} %s' % get_full_version())
...
cli.add_command(import_by_name('{{cookiecutter.project__module}}.cli.commands.upgrade.upgrade'))

logger = logging.getLogger('{{cookiecutter.project__module}}.cli')
