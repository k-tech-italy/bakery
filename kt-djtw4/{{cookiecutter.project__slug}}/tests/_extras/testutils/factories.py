...
from {{cookiecutter.project__slug}}.config import settings
from {{cookiecutter.project__slug}}.core.models import User
from {{cookiecutter.project__slug}}.currencies.models import Currency
